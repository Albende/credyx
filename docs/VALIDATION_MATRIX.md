...
Run: `python scripts/validate_all.py` — 111 countries. Summary: {'BROKEN': 68, 'PARTIAL': 35, 'WORKING': 7, 'NOT_IMPLEMENTED': 1}
...
| BG | **Sopharma AD** | **PARTIAL** | not_impl | pass | pass(1) | ✓ | OK text/html [EPZEU] |  |
...
| PK | Habib Bank Limited | **PARTIAL** | pass | pass | empty |  |  |  |
| PL | Orlen | **PARTIAL** | FAIL:TimeoutError:Locator.fi | pass | pass(3) | ✓ | APP ENDPOINT | FAIL:TimeoutError:Locator.fill: Timeout 30000ms exceeded.
Call log:
  - waiting  |
| PT | EDP | **PARTIAL** | not_impl | pass | empty |  |  |  |
...
| UA | Naftogaz of Ukraine | **PARTIAL** | pass | pass | empty |  |  |  |
